jQuery(function($) {
	...
	html += '<li><a href="#" class="row-layout row-layout-57 sp-tooltip" data-layout="5,7" data-toggle="tooltip" data-placement="top" data-original-title="5/12 + 7/12"></a></li>';
	html += '<li><a href="#" class="row-layout row-layout-custom sp-tooltip" data-layout="" data-type="custom" data-toggle="tooltip" data-placement="top" data-original-title="Custom"></a></li>';
	html += '</ul>';
	html += '</div>';
	html += '</div>';
